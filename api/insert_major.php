  <?php
        ...
        if ($requestMethod == 'POST') {
                        ...
                        $mj_name = mysqli_real_escape_string($conn, $result['mj_name']);
                        $p_id = mysqli_real_escape_string($conn, $result['p_id']);

                        //คำสั่ง SQL สำหรับเพิ่มข้อมูลใน Database
                        $sql = "INSERT INTO `majors` (`mj_id`, `mj_name`, `p_id`) 
                                VALUES (NULL, '$mj_name', '$p_id');";
